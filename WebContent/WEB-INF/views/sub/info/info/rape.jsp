...
<title>성범죄 : 범죄분류 : WeSafer</title>
    <link rel="stylesheet" href="/t/css/reset.css" />
    <link rel="stylesheet" href="/t/css/common.css" />
    <link rel="stylesheet" href="/t/css/sub.css" />
    <link rel="stylesheet" href="/t/css/main.css" />
    ...
    <div id="container"><!-- container S -->
      	...
      	<c:forEach var="i" items="${rs}">
	        ...
	        <ul class="info_list_btn">
				<li><a href="info_update.do?part1=${i.part1}&part2=${i.part1}&idx=${i.idx}&page=${page}">글수정</a></li>
				<li><a href="info_delete.do?part1=${i.part1}&part2=${i.part1}&idx=${i.idx}&page=${page}">글삭제</a></li>
