    ...
    <div id="container"><!-- container S -->
      	...
      	<c:forEach var="i" items="${rs}">
	        ...
	        <ul class="info_list_btn">
				<li><a href="info_update.do?part1=info&part2=${i.part2}&idx=${i.idx}&page=${page}">글수정</a></li>
				<li><a href="info_delete.do?part1=info&part2=${i.part2}&idx=${i.idx}&page=${page}">글삭제</a></li>
