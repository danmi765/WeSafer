...
<body>
    ...
    <div id="container"><!-- container S -->
		...
		<div class="comm_searchBox">
			<form action="comm_list.do" method="post">
				...
				<tr>
					<td>
						<c:forEach var="p" begin="1" end="${total_page}">
							<a href="comm_list.do?part1=comm&part2=notice&page=${p}">
								[
...
<!-- 페이징 -->
	    	...
	    	<ul class="board_list_btn">
	    		<li><a href="comm_insert.do?part1=comm&part2=notice">글쓰기</a></li>
	    	</ul>
	    	<%} %>
	    </div>
       	<!-- 게시판 리스트 끝 -->
