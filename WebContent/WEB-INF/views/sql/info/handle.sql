drop sequence info_handle_seq;
create sequence info_handle_seq start with 1 increment by 1;
...
insert into handle values(info_handle_seq.nextval, sysdate, 1, 0, '', '',  'handle', 'rape', 'admin',
'대처법 - 성범죄',
...
insert into handle values(info_handle_seq.nextval, sysdate, 2, 0, '', '', 'handle', 'robber', 'admin',
'대처법 - 강도/절도',
...
insert into handle values(info_handle_seq.nextval, sysdate, 3, 0, '', '', 'handle', 'violence', 'admin',
'대처법 - 학교폭력',
...
insert into handle values(info_handle_seq.nextval, sysdate, 4, 0, '', '', 'handle', 'drug', 'admin',
'대처법 - 마약/약물',
'
...
insert into handle values(info_idx_seq.nextval, sysdate, 5, 0, '', '', 'handle', 'murder', 'admin',
'대처법 - 살인',
'
...
insert into handle values(info_handle_seq.nextval, sysdate, 6, 0, '', '',  'handle', 'rape', 'admin',
'대처법 - 성범죄',
'성범죄는 성에 관계되는 범죄를 말하며, 타인의 자유의사와 관계없이 가해지는 강간이나 강제추행 등의 범죄를 말한다.
성범죄의 분류[편집]
강간과 추행의 죄 : 개인의 성적 자기결정의 자유를 보호하기 위한 것이며, 성풍속에 관한 죄는 사회적 법익, 즉 사회 일반의 건전한 성도덕 내지 성풍속을 보호하기 위한 것이다. 
...
insert into handle values(info_handle_seq.nextval, sysdate, 7, 0, '', '', 'handle', 'robber', 'admin',
'대처법 - 강도/절도',
'강도(強盗)는 다른 사람의 재산을 빼앗는 범죄자를 말한다. 대한민국의 법(法)에서는 폭행 또는 협박으로 타인의 재물을 강취하거나 기타 재산상의 이익을 취득하거나 또는 제3자로 하여금 이를 취득하게 하는 자 라고 규정하고 있다.'
);

insert into handle values(info_handle_seq.nextval, sysdate, 8, 0, '', '', 'handle', 'violence', 'admin',
'대처법 - 학교폭력',
'폭력은 신체적인 손상을 가져오고, 정신적·심리적인 압박을 가하는 물리적인
강제력을 말한다[1]. 법에서는 다른 사람에게 상해를 입히거나[2] 협박하거나 하는 등
의 행위[3] 와 함께 다른 사람을 감금하는 행위[4],
...
insert into handle values(info_handle_seq.nextval, sysdate, 9, 0, '', '', 'handle', 'drug', 'admin',
'대처법 - 마약/약물',
'
마약은 원래의 의미로는 양귀비의 추출물로서 환각과 중독을 일으키는 알칼로이
드만을, 즉 "아편만이 진정한 의미에서 마약이다."라고 말한다. 일반인들은 대부분의
...
insert into handle values(info_idx_seq.nextval, sysdate, 10, 0, '', '', 'handle', 'murder', 'admin',
'대처법 - 살인',
'
살인은 다른 사람을 살해하는 행위이다. 고의적인 살인을 말하며 고의가 없는 과
실치사상죄와는 구분한다. 살인에 대한 처벌은 국가에 따라서는 사형도 행해진다. 사
...
insert into handle values(info_handle_seq.nextval, sysdate, 11, 0, '', '',  'handle', 'rape', 'admin',
'대처법 - 성범죄',
'성범죄는 성에 관계되는 범죄를 말하며, 타인의 자유의사와 관계없이 가해지는 강간이나 강제추행 등의 범죄를 말한다.
성범죄의 분류[편집]
강간과 추행의 죄 : 개인의 성적 자기결정의 자유를 보호하기 위한 것이며, 성풍속에 관한 죄는 사회적 법익, 즉 사회 일반의 건전한 성도덕 내지 성풍속을 보호하기 위한 것이다. 
...
insert into handle values(info_handle_seq.nextval, sysdate, 12, 0, '', '', 'handle', 'robber', 'admin',
'대처법 - 강도/절도',
'강도(強盗)는 다른 사람의 재산을 빼앗는 범죄자를 말한다. 대한민국의 법(法)에서는 폭행 또는 협박으로 타인의 재물을 강취하거나 기타 재산상의 이익을 취득하거나 또는 제3자로 하여금 이를 취득하게 하는 자 라고 규정하고 있다.'
);

insert into handle values(info_handle_seq.nextval, sysdate, 13, 0, '', '', 'handle', 'violence', 'admin',
'대처법 - 학교폭력',
'폭력은 신체적인 손상을 가져오고, 정신적·심리적인 압박을 가하는 물리적인
강제력을 말한다[1]. 법에서는 다른 사람에게 상해를 입히거나[2] 협박하거나 하는 등
의 행위[3] 와 함께 다른 사람을 감금하는 행위[4],
...
insert into handle values(info_handle_seq.nextval, sysdate, 14, 0, '', '', 'handle', 'drug', 'admin',
'대처법 - 마약/약물',
'
마약은 원래의 의미로는 양귀비의 추출물로서 환각과 중독을 일으키는 알칼로이
드만을, 즉 "아편만이 진정한 의미에서 마약이다."라고 말한다. 일반인들은 대부분의
...
insert into handle values(info_idx_seq.nextval, sysdate, 15, 0, '', '', 'handle', 'murder', 'admin',
'대처법 - 살인',
'
살인은 다른 사람을 살해하는 행위이다. 고의적인 살인을 말하며 고의가 없는 과
실치사상죄와는 구분한다. 살인에 대한 처벌은 국가에 따라서는 사형도 행해진다. 사
