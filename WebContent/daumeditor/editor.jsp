...
<!-- 컨테이너 시작 -->
	...
	<script type="text/javascript">
			...
			sidebar: {
				...
				attacher:{
				    image:{
				        ...
				        popPageUrl:'${pageContext.request.contextPath}/daumeditor/imagePopup.do' //팝업창 주소
				    }
				},
			/* 이미지첨부 관련 추가 config */
				capacity: {
		...
		//다음에디터 내용입력을 검사하는 함수 - Editor.save() 호출 후 자체적으로 호출
		...
		//입력 내용으로 textarea 생성 후 form에 추가하는 함수 - Editor.save() 호출 후 자체적으로 호출
